...
ks_result <- ks.test(usgdp_list$growthrate, "custom_cdfUS")
#H=1
ks_resultone <- ks.test(usgdp_list$growthrate, custom_cdfoneUS)
# Print the result
print(ks_result)
print(ks_resultone)
...
library(moments) # for jarque.bera.test (Jacques Bera ALM test)
